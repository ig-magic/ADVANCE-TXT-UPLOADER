...
SUDO_USERS = [8587087864]

# ✅ Multiple AUTH CHANNELS allowed
AUTH_CHANNELS = [-1003681400118]  # Add more channel IDs here

# Function to check i8587087864f a user is authorized
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/amesbu") ],
                    [
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[𓍯𓂃𓏧♡ —͞𖣘](https://t.me/magic)"
    if raw_text3 == '1':
        CR = '[𓍯𓂃𓏧♡ —͞𖣘](https://t.me/amesbu)'
    elif raw_text3:
        try:
    ...
    await editable.edit("𝗡𝗼𝘄 𝗦𝗲𝗻𝗱 𝗧𝗵𝗲 𝗧𝗵𝘂𝗺𝗯 𝗨𝗿𝗹 𝗘𝗴 » https://graph.org/....\n\n𝗢𝗿 𝗜𝗳 𝗗𝗼𝗻'𝘁 𝗪𝗮𝗻𝘁 𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹 𝗦𝗲𝗻𝗱 = 𝗻𝗼")
